...
import Foundation
import AppKit
public class ZoomedSpectralView : NSView {
    ...
    func drawSpectrum(context: CGContext) {
        ...
        let colors = [NSColor.green.cgColor,NSColor.brown.cgColor ,NSColor.yellow.cgColor, NSColor.red.cgColor]
        let gradient = CGGradient(
            colorsSpace: nil, // generic color space
            colors: colors as CFArray,
            locations: [0.0,0.10, 0.25, 0.50])
        ...
        let headroom : Float = maxDB - minDB
